...
namespace NguyenLeHoangMVC_DataLayer.Models;
...
public partial class FunewsManagementContext : DbContext {
    ...
    //        var config = new ConfigurationBuilder().AddJsonFile("appsettings.json").Build().GetConnectionString("DBConnection");
    //        optionsBuilder.UseSqlServer(config);
    //    }
    //}
    public static FunewsManagementContext INSTANCE = new FunewsManagementContext();
